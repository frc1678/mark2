...
public class ShotLeftBack extends SequentialCommandGroup{

    public ShotLeftBack(Swerve s_Swerve) {
        ...
        Trajectory moveBack =
            TrajectoryGenerator.generateTrajectory(
                ...
                List.of(),
                new Pose2d(1.9, 7.5 , Rotation2d.fromDegrees(0.0)),
        ...
        addCommands(
            new InstantCommand(() -> s_Swerve.resetOdometry(moveBack.getInitialPose())),
            aim,
            shoot,
            moveBackCommand
        );
