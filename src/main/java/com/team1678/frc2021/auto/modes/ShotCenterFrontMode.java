...
// public class ShotCenterFrontMode extends SequentialCommandGroup{

//     public ShotCenterFrontMode(Swerve s_Swerve) {
...
//         addCommands(
//             new InstantCommand(() -> s_Swerve.resetOdometry(new Pose2d(2.90, 5.84, Rotation2d.fromDegrees(0.0)))),
//             aim,
//             shoot,
//             moveFrontCommand,
//             readyGyro
