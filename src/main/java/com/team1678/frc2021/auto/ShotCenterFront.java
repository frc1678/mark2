...
public class ShotCenterFront extends SequentialCommandGroup{

    public ShotCenterFront(Swerve s_Swerve) {
        ...
        addCommands(
            new InstantCommand(() -> s_Swerve.resetOdometry(new Pose2d(2.90, 5.84, Rotation2d.fromDegrees(270.0)))),
            aim,
            shoot,
            moveFrontCommand
        );
