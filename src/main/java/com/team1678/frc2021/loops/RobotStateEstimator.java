...
public class RobotStateEstimator implements Loop {
	...
	public void onLoop(double timestamp) {
		...
		robotState.addFieldToVehicleObservation(timestamp, mSwervePose.getPose());
		...
		ChassisSpeeds chassisVelocity = swerve.getChassisVelocity(translation, rotation);

		com.team254.lib.geometry.Pose2d transVelocity = new com.team254.lib.geometry.Pose2d(translation.getX(), translation.getY(),
																													new com.team254.lib.geometry.Rotation2d(rotation));

		final Twist2d measured_velocity = new Twist2d(translation.getX(), translation.getY(), rotation);
        ...
        mRobotState.addObservations(timestamp, transVelocity, measured_velocity, predicted_velocity);
